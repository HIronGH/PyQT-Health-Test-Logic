...
txt_test3 = 'Лягте на спину і заміряйте пульс спочатку за перші 15 секунд хвилини, потім за останні 15 секунд. хвилини без виміру пульсацій. ' \
...
txt_thirdwin = 'Результати'

#third window
txt_index = "Індекс Руф'є: "
txt_heart_result = 'Працездатність серця: '
